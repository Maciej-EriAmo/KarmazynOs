...
**Data:** 2026-08-07  
**Repo:** `main` (kcc **0.6.1**, TB.4 **Phase 1** lex_buffer, Tor A `ksub_client`)  
...
### 3. TB.4 self-host — **Phase 0 + Phase 1**
- `lex_common.k0` / `tok_kind.k0` (Phase 0)
- `lex_buffer.k0` — ASCII src → kind+span; fixtures A–D (Phase 1)
- w `verify_kcc` (oba exit 0)
...
1. TB.4 Phase 2 — mini-parser (fn/let/return/int) na token stream  
